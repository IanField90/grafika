...
public class OverlayVideoActivity extends AppCompatActivity implements SurfaceHolder.Callback, MoviePlayer.PlayerFeedback {
    ...
    protected int getContentViewId() {
        return R.layout.activity_overlay_video;
    }
